...
if (adc_rstn_i == 1'b0) begin
   ...
   if (adc_trg_dis) begin
      ...
      case (set_trig_src)
          ...
          5'd2 : adc_trig <= CHN == 0 ? adc_trig_p_i[0] : trig_ch_i[0] ; // A ch rising edge
          5'd3 : adc_trig <= CHN == 0 ? adc_trig_n_i[0] : trig_ch_i[1] ; // A ch falling edge
          5'd4 : adc_trig <= CHN == 0 ? adc_trig_p_i[1] : trig_ch_i[2] ; // B ch rising edge
          5'd5 : adc_trig <= CHN == 0 ? adc_trig_n_i[1] : trig_ch_i[3] ; // B ch falling edge
          ...
          5'd10: adc_trig <= CHN == 1 ? adc_trig_p_i[0] : trig_ch_i[0] ; // C ch rising edge
          5'd11: adc_trig <= CHN == 1 ? adc_trig_n_i[0] : trig_ch_i[1] ; // C ch falling edge
          5'd12: adc_trig <= CHN == 1 ? adc_trig_p_i[1] : trig_ch_i[2] ; // D ch rising edge
          5'd13: adc_trig <= CHN == 1 ? adc_trig_n_i[1] : trig_ch_i[3] ; // D ch falling edge
          5'd18: adc_trig <= CHN == 0 ? (adc_trig_p_i[0] | adc_trig_n_i[0]) : (trig_ch_i[0] | trig_ch_i[1]) ; // A ch any edge
          5'd20: adc_trig <= CHN == 0 ? (adc_trig_p_i[1] | adc_trig_n_i[1]) : (trig_ch_i[2] | trig_ch_i[3]) ; // B ch any edge
          5'd22: adc_trig <= ext_trig_p_i | ext_trig_n_i    ; // external any edge
          5'd24: adc_trig <= asg_trig_p_i | asg_trig_n_i    ; // ASG any edge
          5'd26: adc_trig <= CHN == 1 ? (adc_trig_p_i[0] | adc_trig_n_i[0]) : (trig_ch_i[0] | trig_ch_i[1]) ; // C/A any edge
          5'd28: adc_trig <= CHN == 1 ? (adc_trig_p_i[1] | adc_trig_n_i[1]) : (trig_ch_i[2] | trig_ch_i[3]) ; // D/B any edge
