...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.C_EXT_RST_WIDTH {1} $proc_sys_reset
...
\
  ...
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn  [get_bd_pins proc_sys_reset/interconnect_aresetn] \
  [get_bd_pins axi_protocol_converter_0/aresetn] \
  ...
  connect_bd_net -net processing_system7_0_fclk_clk0  [get_bd_pins processing_system7/FCLK_CLK0] \
  [get_bd_ports FCLK_CLK0]
  connect_bd_net -net processing_system7_0_fclk_clk1  [get_bd_pins processing_system7/FCLK_CLK1] \
  [get_bd_ports FCLK_CLK1]
  connect_bd_net -net processing_system7_0_fclk_clk2  [get_bd_pins processing_system7/FCLK_CLK2] \
  ...
  [get_bd_pins axi_protocol_converter_0/aclk] \
  [get_bd_pins axi_register_slice_0/aclk] \
  [get_bd_pins proc_sys_reset/slowest_sync_clk] \
  [get_bd_pins xadc/s_axi_aclk]
  connect_bd_net -net processing_system7_0_fclk_reset0_n  [get_bd_pins processing_system7/FCLK_RESET0_N] \
  [get_bd_ports FCLK_RESET0_N]
  connect_bd_net -net processing_system7_0_fclk_reset1_n  [get_bd_pins processing_system7/FCLK_RESET1_N] \
  [get_bd_ports FCLK_RESET1_N]
  connect_bd_net -net processing_system7_0_fclk_reset2_n  [get_bd_pins processing_system7/FCLK_RESET2_N] \
  [get_bd_ports FCLK_RESET2_N]
  connect_bd_net -net processing_system7_0_fclk_reset3_n  [get_bd_pins processing_system7/FCLK_RESET3_N] \
  ...
  connect_bd_net -net xlconstant_dout  [get_bd_pins xlconstant/dout] \
  [get_bd_pins proc_sys_reset/aux_reset_in]
